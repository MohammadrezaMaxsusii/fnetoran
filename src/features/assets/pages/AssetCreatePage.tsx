    ...
    <div className="pe-5 pb-5">
      <section className="w-full bg-gray-darker rounded-2xl">
        ...
        <div className="flex items-center justify-between p-7">
          <span className="text-lg font-bold text-primary">New Asset</span>
          <Button
            variant="secondary"
        ...
        <div className="p-7 flex gap-12">
          <div className="bg-background-default rounded-xl p-4.5 w-1/4 space-y-3">
            {/* Sidebar of content */}
            {assetTypes?.data.map(({ id, name }: { id: number, name: string }) => {
              const isActive = `/adminstration/assets/create/${id}` === pathname;
