...
export const AssetCreateForm = () => {
  ...
  const { assetFields, assetFieldsIsLoading } = useAssetFieldsQuery(id as string);
  ...
  const onSubmit = async (values: FormValues) => {
      ...
      createAssetAction.mutate(payload, {
        ...
        onSuccess: () => {
          form.reset();
          navigate(`/adminstration/assets/${id}`)
        }
      })
  };
              ...
              <FormItem>
                ...
                <FormControl>
                  <Popover
                    ...
                    onOpenChange={(isOpen) =>
                      setOpen(isOpen ? "warranty_expiry" : "")
                    }
                  >
                    <PopoverTrigger asChild>
                      <Button
