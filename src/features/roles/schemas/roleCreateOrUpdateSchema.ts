...
export const roleFormSchema = z.object({
  ...
  maxRequestPerMinute: z.coerce.number().min(10, "min request in per minutes must be at least 10.").max(1000, "max request in per minutes must be less than 1000.").optional(),
