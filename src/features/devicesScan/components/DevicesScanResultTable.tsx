...
import { useDeviceScanResultFilters, useDevicesScanResultQuery } from '../hooks'
			...
			{devicesScanResultIsLoading ? (
				...
				<div className='px-7 pb-7'>
					<Table className='border-separate border-spacing-y-1'>
						...
						{/* Table body */}
						<TableBody>
							{devicesScanResult?.data.results.map(
								(deviceScanResult: any) => (
									<TableRow
