								...
								>
									...
									<TableCell className='w-1/6 px-11 py-2 text-end rounded-r-lg space-x-1.5 border-y border-e border-default'>
										...
										<DeleteModal
											title='Device Scan'
											isLoading={
												deleteBasicDeviceScanAction.isPending
											}
											onClick={() =>
												deleteBasicDeviceScanAction.mutate(
													deviceScan.id,
													{
														onSuccess: data => {
															toast.success(
										...
										<Button
											...
											onClick={() => {
												...
												createBasicScanStartAction.mutate(
													deviceScan.id,
													{
														onSuccess: () => {
															toast.success(
