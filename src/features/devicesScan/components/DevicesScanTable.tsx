...
import { useDevicesScanFilters } from "../hooks";
            ...
            <TableBody>
              {devicesScan?.data.map((deviceScan: any) => (
                ...
                >
                  ...
                  {/* Device created at */}
                  <TableCell className="px-4 py-2 text-center border-y border-default">
                    {getDate(deviceScan.createdAt)} | {getTime(deviceScan.createdAt)}
                  </TableCell>
                  ...
                  {/* Operation section */}
                  <TableCell className="w-1/6 px-4 py-2 text-center rounded-r-lg space-x-1.5 border-y border-e border-default">
                    {/* edit deviceScan */}
                    {/* <DeviceUpdate deviceScan={deviceScan} /> */}

                    {/* Delete deviceScan */}
                    <DeleteModal title="Device Scan" onClick={() => {}} />

                    {/* View deviceScan */}
                    <Button
                      className="p-2.5! bg-navy-blue hover:bg-navy-blue border border-primary text-primary"
                      // onClick={() => navigate(`/devices/scan/${deviceScan.id}`)}
                      onClick={() => {}}
                    >
