...
import { devicesScanResultDetailsTableConstantItems } from '../constants'
import { useDeviceScanResultDetailsFilters } from '../hooks'
				...
				<section className='w-full bg-gray-darker rounded-2xl space-y-2'>
					...
					<Empty className='pt-3! pb-7! gap-2'>
						<EmptyHeader>
							...
							<EmptyTitle>
								Scan Result Details List Empty!
							</EmptyTitle>
						</EmptyHeader>
						<EmptyContent className='text-sm text-muted-foreground'>
							Scan Result Details will appear here once they are
							added.
						</EmptyContent>
					</Empty>
				</section>
								...
								(deviceScanResultDetails: any) => (
									...
									>
										...
										<TableCell className='w-1/6 px-4 py-4 text-center rounded-r-lg space-x-1.5 border-y border-e border-default'>
											{getDate(
												deviceScanResultDetails.createdAt
											)}{' '}
											|{' '}
											{getTime(
												deviceScanResultDetails.createdAt
