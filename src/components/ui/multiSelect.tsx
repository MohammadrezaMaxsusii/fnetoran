...
const multiSelectVariants = cva("m-1", {
	variants: {
		variant: {
			default: "border-foreground/10 text-forground bg-primary hover:bg-primary",
			secondary:
				...
				<Popover
					...
					<PopoverTrigger asChild>
						<Button
							...
							className={cn(
								"flex p-1 rounded-md border min-h-10 h-auto items-center justify-between bg-muted hover:bg-muted [&_svg]:pointer-events-auto",
